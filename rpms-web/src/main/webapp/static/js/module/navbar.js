    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    if (data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0) {
                        ...
                        for (var k = 0; k < grandsonNodes.length; k++) {
                            ulHtml += '<dd>';
                            ulHtml += '<a href="'+ grandsonNodes[k].url +'"class=site-demo-active   data-id='+k+'>' + grandsonNodes[k].name + '</a>';
                            ulHtml += '</dd>';
                        }
                        ulHtml += '</dl>';
                        ulHtml += '</dd>';
                        ...
                        ulHtml += '<dd>';
                        ulHtml += '<a href="#" data-title="'+data[i].children[j].name+'" data-url="'+data[i].children[j].url+'"  data-type="tabAdd" class=site-demo-active data-id='+k+'>' + data[i].children[j].name;
                        ulHtml += '</a>';
                        ulHtml += '</dd>';
                        k++;
                    }
                ...
                ulHtml += '<a href="' + data[i].url + '"' + dataUrl + '>';
                if (data[i].icon !== undefined && data[i].icon !== '') {
                    if (data[i].icon.indexOf('fa-') !== -1) {
                        ulHtml += '<i class="fa ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + ' data-id='+i+'"></i>';
                    } else {
                        ulHtml += '<i class="layui-icon" data-icon="' + data[i].icon + ' data-id='+i+'">' + data[i].icon + '</i>';
                    }
                }
