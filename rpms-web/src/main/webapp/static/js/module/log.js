layui.use(['table','jquery','layer','form'], function() {
    ...
    table.render({
        ...
        ,cols: [[
            {type:'checkbox'}
            ,{field:'type', width:80, title: '日志类型', sort: true}
            ,{field:'title', width:80, title: '日志标题', sort: true}
            ,{field:'remoteaddr', width:80, title: '请求地址', sort: true}
            ,{field:'requesturi', width:80, title: 'URI', sort: true}
            ,{field:'method', width:80, title: '请求方式', sort: true}
            ,{field:'exception', width:80, title: '异常', sort: true}
            ,{field:'operatedate', width:80, title: '开始时间', sort: true}
            ,{field:'timeout', width:80, title: '结束时间', sort: true}
    ...
    var Allmethods={
        ...
        delete(){
            ...
            layer.confirm('你确认删除吗?', {icon: 3, title:'提示'}, function(index){
                ...
                $.get("/log/delete",{"ids":ids.toString()},function(result){
                    if(result.success){
